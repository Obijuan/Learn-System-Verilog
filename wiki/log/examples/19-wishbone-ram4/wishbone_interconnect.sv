...
module wishbone_interconnect #(
    ...
    for (genvar slave = 0; slave < NUM_SLAVES; slave++) begin : gen_0
    ...
    for (genvar slave = 0; slave < NUM_SLAVES; slave++) begin : gen_1
    ...
    for (genvar slave = 0; slave < NUM_SLAVES; slave++) begin : gen_2
