...
apio raw -- yosys -m slang \
    -p "read -sv memory.sv" \
    -p "read_slang --ignore-unknown-modules wishbone_interface.sv \
        ...
        wishbone_uart.sv wishbone_ram.sv" \
...
#yosys -l yosys.log \
#           -m slang \
#           -p "read -sv rom_sync.sv my_wrapped_rom.sv" \
#           -p "read_slang --ignore-unknown-modules --top top top.sv" \
#           -p "synth_ecp5 -json out.json"